...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7863205118:AAGBgMOQy44Wp_tiUC55gUnsgyMr7EJovJY")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002293265441"))
...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://sunitverma080:vjFiRqluQhZsSJbZ@cluster0.nuvj8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DB_NAME = os.environ.get("DATABASE_NAME", "prox")
